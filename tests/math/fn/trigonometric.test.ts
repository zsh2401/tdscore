...
describe("Trigonometric function's test", () => {
    it("sin", () => {
        ...
        expect(sin(PI / 4).toJSNumber()).toBeCloseTo(sqrt(2) / 2); // 45°
        expect(sin(PI / 3).toJSNumber()).toBeCloseTo(sqrt(3) / 2); // 60°

        expect(sin(PI / 2).toJSNumber()).toBeCloseTo(1); // 90°

        expect(sin(2 * PI / 3).toJSNumber()).toBeCloseTo(sqrt(3) / 2); // 120°
        expect(sin(3 * PI / 4).toJSNumber()).toBeCloseTo(sqrt(2) / 2); // 135°
    ...
    it("cos", () => {
        ...
        expect(cos(PI / 6).toJSNumber()).toBeCloseTo(sqrt(3) / 2); // 30°
        expect(cos(PI / 4).toJSNumber()).toBeCloseTo(sqrt(2) / 2); // 45°
        ...
        expect(cos(3 * PI / 4).toJSNumber()).toBeCloseTo(-(sqrt(2) / 2)); // 135°
        expect(cos(5 * PI / 6).toJSNumber()).toBeCloseTo(-(sqrt(3) / 2)); // 150°
